...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Amruthavarshini Sriram",
    description: `Electronics and Communication Engineering student at NIT Warangal. Passionate about software development and data science.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.amruthavarshini.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.amruthavarshini.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Amruthavarshini Sriram" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Amruthavarshini" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Amruthavarshini</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Amruthavarshini Sriram. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
